...
const Etiquetados = () => {
  ...
  return (
    ...
    >
      ...
      {selectedPost?.etiquets?.length > 0 ? (
        selectedPost?.etiquets?.map((tag, index) => (
          <Pressable
            onPress={() => {
              ...
              navigation.navigate("OtherUserProfile", tag);
            }}
            key={index}
