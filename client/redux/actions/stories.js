...
export const getAllStories = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await axiosInstance.get(`/histories`)
      return data
    } catch (error) {
...
export const getStoryById = createAsyncThunk(
  ...
  async (storyId) => {
    try {
      const { data } = await axiosInstance.get(`/histories/${storyId}`)
      return data
    } catch (error) {
      throw new Error(error)
    }
...
export const getAllUserStories = createAsyncThunk(
  ...
  async (userId) => {
    try {
      const { data } = await axiosInstance.get(`/histories/user/${userId}`)
      return data
    } catch (error) {
      throw new Error(error)
    }
...
export const postStory = createAsyncThunk(
  ...
  async (story) => {
    try {
      const { data } = await axiosInstance.post(`/histories`, story)
      return data
    } catch (error) {
      throw new Error(error)
    }
...
export const getStoryRelatedData = createAsyncThunk(
  'getStoryRelatedData/stories',
  async (storyId) => {
    try {
      const { data } = await axiosInstance.post(
        `/histories/${storyId}/info-relation`
      )
      return data
    } catch (error) {
      throw new Error(error)
